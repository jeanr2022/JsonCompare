...
counts as **5 removed** lines (`{`, three properties, `}`), not 3l. This keeps the numbers consistent with what's visually displayed — every red/green/yellow row in the output contributes exactly 1 to the count.
